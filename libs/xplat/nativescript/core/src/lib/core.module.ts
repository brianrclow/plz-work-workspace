...
import { fontAwesomeIcons } from '@plz-work-workspace/xplat/nativescript/utils';

// libs
import { TranslateLoader, TranslateModule } from '@ngx-translate/core';
import { CoreModule, PlatformLanguageToken, PlatformWindowToken } from '@plz-work-workspace/xplat/core';
...
export class PlzWorkWorkspaceCoreModule {
  constructor(
    @Optional()
    @SkipSelf()
    parentModule: PlzWorkWorkspaceCoreModule
  ) {
    throwIfAlreadyLoaded(parentModule, 'PlzWorkWorkspaceCoreModule');
  }
}
